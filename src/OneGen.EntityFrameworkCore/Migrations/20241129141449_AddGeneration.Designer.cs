...
{
    [DbContext(typeof(OneGenDbContext))]
    [Migration("20241129141449_AddGeneration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OneGen.Generation.Subject", b =>
                {
                    b.Property<Guid>("Id")
                    ...
                    b.ToTable("AppSubjects", "Generation");
                });

            modelBuilder.Entity("OneGen.Generation.Task", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppTasks", "Generation");
                });

            modelBuilder.Entity("OneGen.Generation.Variant", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppVariants", "Generation");
                });
            ...
            modelBuilder.Entity("OneGen.Generation.Task", b =>
                {
                    b.HasOne("OneGen.Generation.Subject", null)
                        .WithMany()
            ...
            modelBuilder.Entity("OneGen.Generation.Variant", b =>
                {
                    b.HasOne("OneGen.Generation.Task", null)
                        .WithMany()
